...
namespace MbmStore.Infrastructure
{
    public class Repository
    {
        ...
        {
            // movies
            Movie jungleBook = new Movie("Jungle Book", 160.50m, "junglebook.jpg", "Elgars Logins",2000);
            Products.Add(jungleBook);
            Movie Movie2 = new Movie("Die Hard", 160.50m, "die.png", "Roderick Thorp", 1988);
            Products.Add(Movie2);
            Movie Movie3 = new Movie("The Wolf of Wall Street", 160.50m, "wolf.jpg", "Martin Scorsese", 2013);
            Products.Add(Movie3);
            Movie Movie4 = new Movie("Rocky Balboa", 160.50m, "rocky.jpeg", "Sylvester Stallone", 2006);
            Products.Add(Movie4);
            Movie Movie5 = new Movie("Creed II", 160.50m, "creed.jpg", "Steven Caple Jr.", 2018);
            Products.Add(Movie5);

            //books
            Book Book1 = new Book("Paulo Coelho", "The Alchemist", 300m, 1988, "HarperTorch", "404", "alchemist.jpg");
            Products.Add(Book1);
            Book Book2 = new Book("Dmitry Glukhovsky", "Metro 2030", 179m, 2016, "Saxo", "400", "saxo.jpg");
            Products.Add(Book2);
            Book Book3 = new Book("Jesse Liberty", "Programming C# 3.0", 579m, 2002, "AbeBooks", "400", "cc.jpg");
            Products.Add(Book3);
            Book Book4 = new Book("Douglas Crockford", "JavaScript: The Good Parts", 551m, 2008, "AbeBooks", "400", "js.png");
            Products.Add(Book4);

            //musicCDs
            MusicCD MusicCD1 = new MusicCD("Nickelback", "Feed the Machine", 200m, 2017, "nickelback.jpg");
            ...
            MusicCD MusicCD2 = new MusicCD("21 Pilots", "Blurryface", 100m, 2015, "pilots.png");
            ...
            //customers
            Customer Customer1 = new Customer("Valerija", "Krastina", "Engtoften 6", "8260", "Viby J", new DateTime(1997, 5, 20));
            Customer1.AddPhoneNumber("50334779");
            Customer1.AddPhoneNumber("26533280");
            Customers.Add(Customer1);
            Customer Customer2 = new Customer("Elgars", "Logins", "Engtoften 6", "8260", "Viby J", new DateTime(1994, 8, 3));
